...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Dosen - Reservasi TULT</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/dosen/dashboard">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-bs-toggle="dropdown">
                            <i class="bi bi-person-circle"></i> ${dosen.nama}
                        </a>
                        <ul class="dropdown-menu">
                            <li><span class="dropdown-item-text"><small>NIP: ${dosen.nip}</small></span></li>
                            <li><span class="dropdown-item-text"><small>Unit Kerja: ${dosen.unitKerja}</small></span></li>
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"><i class="bi bi-person-badge"></i> Selamat Datang, ${dosen.nama}!</h4>
                        <div class="row mt-3">
                            <div class="col-md-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">${dosen.nip}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">${dosen.unitKerja}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Dapat Mengajukan</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="dosen-info">
            <h5><i class="bi bi-info-circle-fill"></i> Informasi Dosen</h5>
            <p class="mb-1">Sebagai dosen, Anda memiliki hak untuk mengajukan reservasi ruangan untuk keperluan perkuliahan, penelitian, atau kegiatan akademik lainnya.</p>
        </div>
                                            ...
                                            <c:forEach var="reservasi" items="${reservasiList}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- FITUR BARU: Selesaikan jika DISETUJUI -->
                                                        <c:if test="${reservasi.status == 'DISETUJUI'}">
                                                            <form action="${pageContext.request.contextPath}/reservasi" method="post" style="display: inline;">
                                                                <input type="hidden" name="action" value="selesaikan">
                                                                <input type="hidden" name="kode" value="${reservasi.kodeReservasi}">
                                                                <button type="submit" class="btn btn-sm btn-success"
                                                                        onclick="return confirm('Tandai reservasi ${reservasi.kodeReservasi} sebagai selesai? Ruangan akan kembali tersedia.')">
                                                                    <i class="bi bi-check-circle-fill"></i> Selesaikan
                                                                </button>
                                                            </form>
                                                        </c:if>

                                                        <button class="btn btn-sm btn-info" onclick="lihatDetail('${reservasi.kodeReservasi}')">
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#reservasiModal"
                                                    onclick="pilihRuangan('${ruangan.kode}')" <c:if test="${!ruangan.tersedia}">disabled</c:if>>
    ...
    <!-- Modal Ajukan Reservasi (Dropdown Jam 30 Menit) -->
    <div class="modal fade" id="reservasiModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="bi bi-calendar-plus"></i> Ajukan Reservasi Ruangan</h5>
                ...
                <form action="${pageContext.request.contextPath}/reservasi" method="post" id="formReservasi">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Pilih ruangan yang masih tersedia</div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Tanggal</label>
                            <input type="date" name="tanggal" class="form-control" required min="<%= java.time.LocalDate.now() %>">
                            <div class="form-text">Tanggal minimal hari ini</div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-text">Jam mulai paling awal 06:30</div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-text">Jam selesai paling akhir 21:00</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="keperluan" class="form-control" rows="3"
                                      placeholder="Contoh: Perkuliahan, Seminar, Rapat Jurusan" required></textarea>
                        </div>
                    </div>
    ...
    <script>
        ...
        function lihatDetail(kodeReservasi) {
            alert('Detail untuk reservasi: ' + kodeReservasi + '\nFitur detail akan segera hadir!');
        }
